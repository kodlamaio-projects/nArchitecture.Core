...
#pragma warning restore S112 // General or reserved exceptions should never be thrown
    ...
    public override Task HandleBusinessException(BusinessException businessException)
    {
    ...
    public override Task HandleValidationException(ValidationException validationException)
    {
        Response.StatusCode = StatusCodes.Status400BadRequest;
    ...
    public override Task HandleAuthorizationException(AuthorizationException authorizationException)
    {
    ...
    public override Task HandleNotFoundException(NotFoundException notFoundException)
    {
